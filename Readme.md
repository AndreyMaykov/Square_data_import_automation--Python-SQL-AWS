...
#### Project background
Initially, the Square Data Import system was meant to facilitate operating <a href="https://github.com/AndreiMaikov/MVM_Shipping--SQL">an online marketplace</a> (further referred to as **OM**), which was under development at the time. It was expected that some of the vendors participating in OM might also offer their products on other platforms (e.g. Square, Shopify, Squarespace), so the goal of SDIAP was to ensure catalog consistency between OM and the Square platform. This determined the requirements to the data import system and, up to a point, its design.
...
![ ](https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/images/DB_ER_diagram.png) 
...
<a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/docs/catalog_example.txt">An example catalog JSON string</a> and 
<a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/docs/catalog_example_diagram.png">its diagram</a>
...
<a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/src/CatalogETL/">**CatalogETL**</a> 
and 
<a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/src/TokenUpdate/">**TokenUpdate**</a>
...
<a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/src/TokenUpdate/connection_param.py">connection_param.py</a> file.
...
![ ](https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/images/ctlg_import.svg)

To transform the catalog data as discussed [above](#string_structure), two dictionaries – <a href="https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/src/CatalogETL/attribute_dict.py">PRODUCT_ATTRIBUTE_DICT and VARIATION_ATTRIBUTE_DICT</a> –   are used. 
They define: 
...
![ ](https://github.com/AndreiMaikov/Square_data_import_automation--Python_SQL_AWS/blob/master/images/ctlg_load_upd_del.svg)
